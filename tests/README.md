...
| `test_session` | reading another browser's open tabs off disk: the mozlz4 container, both LZ4 decoders against a *reference implementation* on this machine's real Firefox session, and the profiles.ini trap where `Default=1` names a stub |
