...
// script.
//
// The reason is the one sec 11.5 gives for extractors and sec 12 for filters, and it
...
public:
	...
	// being well-formed; it has to survive the same kind of breadth check sec 12.4
