...
void extractor_dialog::rebuild_payload() {
	...
	if (!m_served.isEmpty())
		payload += "The notes under the table settle what the extension cannot: "
		            ...
		            "can count for itself. Test it in code freely — `seen === 1` "
		            "is a manifest, a high count is a segment. It is what an "
		            "address serves that you must decide now, not how often it "
		            "was asked for.\n\n"
